...
class SalesEventAdmin(admin.ModelAdmin):
    ...
    list_filter = ("entry_kind", "planning_year", "channel")
    search_fields = ("channel__name", "product__product_name", "product__crop__name")
    raw_id_fields = ("planning_year", "channel", "product", "pack_batch")
