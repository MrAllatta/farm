...
urlpatterns = [
    ...
    path("planting/delete/", views.PlantingDeleteView.as_view(), name="planting_delete"),
    path("planning-year/set/", views.PlanningYearSetView.as_view(), name="set_planning_year"),
    path("season/rollover/", views.SeasonRolloverPreviewView.as_view(), name="season_rollover_preview"),
    path("season/init-blank/", views.SeasonInitBlankView.as_view(), name="season_init_blank"),
    path(
        "season/rollover/commit/",
        views.SeasonRolloverCommitView.as_view(),
        name="season_rollover_commit",
    ),
    ...
    path(
        ...
        views.SalesPlanByChannelView.as_view(),
        name="sales_plan_by_channel",
    ),
