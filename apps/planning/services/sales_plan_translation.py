...
from reference.models import CropBySeason, SalesChannel
from sales.models import SalesEvent


def build_demand_to_supply_draft(planning_year: PlanningYear, channel: SalesChannel) -> dict:
    ...
    planned_events = (
        ...
        .order_by("sale_date", "product__crop__name", "product__product_name")
    )
